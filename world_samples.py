...
def gen_3t(): return generate_random_world_plain(map_h=300, map_w=300, num=100, init_dist=DIS_SCFAC, min_dist=NEAR*2, max_dist=DIS_SCFAC, ang_lim=pi*1.0, ang_init='half', spd_init=0.0, near=NEAR-0.5)
