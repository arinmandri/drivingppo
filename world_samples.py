...
def gen_0():  return generate_random_world_plain(map_h=100, map_w=100, num=1,                min_dist=30, max_dist=30, ang_init='half', ang_lim=0,      spd_init=0)
