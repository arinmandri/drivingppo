...
def gen_3t(): return generate_random_world_plain(map_h=300, map_w=300, num=20, init_dist=30.0, min_dist=10.0, max_dist=30.0, ang_lim=pi*1.0, ang_init='half', spd_init=0.0, near=NEAR-1.0)  # 학습용: 도달판정범위 약간 작게
