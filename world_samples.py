...
def gen_1():  return generate_random_world_plain(map_h=100, map_w=100, num=1,                min_dist=NEAR*2, max_dist=20,        ang_init='half', ang_lim=0,      spd_init=0,      near=2)
def gen_2():  return generate_random_world_plain(map_h=150, map_w=150, num=2,                min_dist=NEAR*2, max_dist=DIS_SCFAC, ang_init='rand', ang_lim=pi*1.0, spd_init='rand')
def gen_2t(): return generate_random_world_plain(map_h=150, map_w=150, num=2,                min_dist=NEAR*2, max_dist=DIS_SCFAC, ang_init='rand', ang_lim=pi*1.0, spd_init='rand', near=NEAR-0.5)  # 학습용: 도달판정범위 약간 작게
