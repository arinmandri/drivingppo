...
from world_samples import gen_21, gen_22, gen_env_plain, gen_env_obs, generate_random_world_plain
...
if __name__ == "__main__":
    ...
    world = generate_random_world_plain(map_h=150, map_w=150, num=13, wpoint_dist_min=4,  wpoint_dist_max=25, ang_init='rand', ang_lim=pi*0.3, spd_init=0.0)
